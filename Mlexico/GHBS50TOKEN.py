#50 TOKENS GABRIEL HASSAN BRUNO SANCHEZ 6M 18AGO24
...
class LexicalAnalyzer:
    ...
    def __init__(self):
        ...
        self.tokens = ['ID', 'RESERVED', 'MAIN', 'RETURN','DATA_TYPE', 'LPAREN', 'RPAREN', 'LBRACKET', 'RBRACKET', 'LBRACE', 'RBRACE', 
                       ...
                       #'SCOMILLAS', 'CCOMILLAS', 
                       'SSTRING', 'CSTRING', 'EQUAL_LESS_THAN','EQUAL_GREATER_THAN','NOEQUAL', 'BRUNO','HASSAN','GABRIEL','SANCHEZ','MATRICULA',
                       'UNIVERSIDAD','PROFESOR','MATERIA','NUMACTIVIDAD','DESPIDO']
...
analizador.analyzer(data)
print(analizador.states_list)
