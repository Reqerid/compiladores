...
// Segunda página
$pdf->AddPage();
$pdf->SetLink($link, -1); // Mantener enlace al navegar entre páginas

// Verificar si la imagen existe antes de agregarla
$imagePath = 'Reporte.png';
if (file_exists($imagePath)) {
    $pdf->Image($imagePath, 10, 12, 30, 0, 'PNG', 'http://www.fpdf.org');
} else {
    $pdf->SetY(15);
    $pdf->SetFont('Arial', 'B', 12);
    $pdf->SetTextColor(255, 0, 0);
    $pdf->Cell(0, 10, 'Imagen no encontrada: ' . $imagePath, 0, 1, 'C');
}
